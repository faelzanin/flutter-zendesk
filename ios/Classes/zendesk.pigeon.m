...
+(SetVisitorInfoRequest*)fromMap:(NSDictionary*)dict {
  ...
  result.visitorName = dict[@"visitorName"];
  if ((NSNull *)result.visitorName == [NSNull null]) {
    result.visitorName = nil;
  }
  result.visitorEmail = dict[@"visitorEmail"];
  if ((NSNull *)result.visitorEmail == [NSNull null]) {
    result.visitorEmail = nil;
  }
  result.visitorPhone = dict[@"visitorPhone"];
  if ((NSNull *)result.visitorPhone == [NSNull null]) {
    result.visitorPhone = nil;
  }
  return result;
}
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.visitorName ? self.visitorName : [NSNull null]), @"visitorName", (self.visitorEmail ? self.visitorEmail : [NSNull null]), @"visitorEmail", (self.visitorPhone ? self.visitorPhone : [NSNull null]), @"visitorPhone", nil];
}
@end
